...
public class MetadataCollection :
    AppReadOnlyDictionary<string, object>,
    ...
    IJson
{
    ...
    public static MetadataCollection FromDictionary(IDictionary<string, object> source) => source.IsNullOrEmpty() ? Empty : new(source) { };
    ...
    /// </summary>
    protected MetadataCollection(IDictionary<string, object> source) : base(source) { }
    /// <summary>
    /// This constructor initializes an empty <see cref="MetadataCollection"/>. <br></br>
    /// It is also to be used by the ORM. 
    /// </summary>
    private MetadataCollection() : base() { }
}
