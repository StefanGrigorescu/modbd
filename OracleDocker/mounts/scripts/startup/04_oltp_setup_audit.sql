...
BEGIN
    ...
    FROM USER_SEQUENCES
    WHERE UPPER(SEQUENCE_NAME) = 'ESHOP_OLTP_LOGS_SEQ';

    IF seq_exists = 0 THEN
        EXECUTE IMMEDIATE '
            CREATE SEQUENCE ESHOP_OLTP_LOGS_SEQ
            START WITH 1
            INCREMENT BY 1
            NOCACHE
            NOCYCLE';
        DBMS_OUTPUT.PUT_LINE('Sequence ESHOP_OLTP_LOGS_SEQ created.');
    ELSE
        DBMS_OUTPUT.PUT_LINE('Sequence ESHOP_OLTP_LOGS_SEQ already exists.');
    END IF;
END;
/
...
BEGIN
    ...
    FROM USER_TABLES
    WHERE UPPER(TABLE_NAME) = 'ESHOP_OLTP_LOGS';
    ...
    IF table_exists = 0 THEN
        ...
        DBMS_OUTPUT.PUT_LINE('Table ESHOP_OLTP_LOGS created.');
    ELSE
        DBMS_OUTPUT.PUT_LINE('Table ESHOP_OLTP_LOGS already exists.');
    END IF;
END;
/
...
BEGIN
    INSERT INTO ESHOP_OLTP_LOGS (id, message, message_type, created_by, created_at, current_user)
    VALUES (ESHOP_OLTP_LOGS_SEQ.NEXTVAL, message, 'D', created_by, SYSDATE, USER);
...
BEGIN
    INSERT INTO ESHOP_OLTP_LOGS (id, message, message_type, created_by, created_at, current_user)
    VALUES (ESHOP_OLTP_LOGS_SEQ.NEXTVAL, message, 'I', created_by, SYSDATE, USER);
...
BEGIN
    INSERT INTO ESHOP_OLTP_LOGS (id, message, message_type, created_by, created_at, current_user)
    VALUES (ESHOP_OLTP_LOGS_SEQ.NEXTVAL, message, 'W', created_by, SYSDATE, USER);
...
BEGIN
    INSERT INTO ESHOP_OLTP_LOGS (id, message, message_type, created_by, created_at, current_user)
    VALUES (ESHOP_OLTP_LOGS_SEQ.NEXTVAL, message, 'E', created_by, SYSDATE, USER);
...
BEGIN
    INSERT INTO ESHOP_OLTP_LOGS (id, message, message_type, created_by, created_at, current_user)
    VALUES (ESHOP_OLTP_LOGS_SEQ.NEXTVAL, message, 'C', created_by, SYSDATE, USER);
