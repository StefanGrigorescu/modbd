...
BEGIN
    ...
    IF pdb_exists = 0 THEN
        EXECUTE IMMEDIATE 'CREATE PLUGGABLE DATABASE ESHOP_GLOBAL ADMIN USER global_admin IDENTIFIED BY "GlobalAdminPassword123!" ROLES = (DBA) FILE_NAME_CONVERT = (''/opt/oracle/oradata/ORCLCDB/pdbseed'', ''/opt/oracle/oradata/GLOBALCDB/ESHOP_GLOBAL'')';
    ...
    IF pdb_exists = 0 THEN
        EXECUTE IMMEDIATE 'CREATE PLUGGABLE DATABASE ESHOP_MUNTENIA ADMIN USER muntenia_admin IDENTIFIED BY "MunteniaAdminPassword123!" ROLES = (DBA) FILE_NAME_CONVERT = (''/opt/oracle/oradata/ORCLCDB/pdbseed'', ''/opt/oracle/oradata/MUNTENIACDB/ESHOP_MUNTENIA'')';
    ...
    IF pdb_exists = 0 THEN
        EXECUTE IMMEDIATE 'CREATE PLUGGABLE DATABASE ESHOP_ROMANIA ADMIN USER romania_admin IDENTIFIED BY "RomaniaAdminPassword123!" ROLES = (DBA) FILE_NAME_CONVERT = (''/opt/oracle/oradata/ORCLCDB/pdbseed'', ''/opt/oracle/oradata/ROMANIACDB/ESHOP_ROMANIA'')';
