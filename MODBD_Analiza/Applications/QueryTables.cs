...
internal static class QuerySingleTable
{
    ...
    internal sealed record QueryBuilder<TTable>(
        TTable Table,
        Func<TTable, IReadOnlyList<Column>> Select
    ) where TTable : Table<TTable>
    {
...
internal static class QueryTwoTables
{
    ...
    internal sealed class JoinBuilder<TTable1, TTable2>(
    ...
    internal sealed class QueryBuilder<TTable1, TTable2>(
        AliasedTable<TTable1> Table1,
        AliasedTable<TTable2> Table2,
        Func<TTable1, TTable2, IReadOnlyList<ConditionWithOtherColumn>> On,
