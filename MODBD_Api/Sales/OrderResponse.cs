...
public sealed record SelectOrdersWithItemsSpecification
{
    ...
    private string Orders => Tenant == Tenant.Oltp ?
        "vw_sls_orders" :
        "sls_orders";
    private string OrderItems => Tenant == Tenant.Oltp ?
        "vw_sls_order_items" :
        "sls_order_items";
    private string Products => Tenant == Tenant.Oltp ?
        "vw_sls_products" :
        "sls_products";
    private string OrderStatuses => Tenant == Tenant.Oltp ?
    ...
    public static OrderResponse MapToOrderResponse(IGrouping<long, OrderWithItemDb> orderItems)
    {
    ...
    public sealed record OrderWithItemDb
    {
        public required long Id { get; init; }
        public required long CustomerId { get; init; }
        public required int CustomerRegionId { get; init; }
